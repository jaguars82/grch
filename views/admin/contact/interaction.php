...
<div class="interaction white-block">
    <h2 class="bordered"><?= $this->title ?></h2>
    ...
    <div class="row" style="margin-bottom: 15px; margin-top: 30px">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select id="developer-select" class="form-control" style="width: 100%">
                    <option value=""></option>
        ...
        <div class="col-md-6">
            ...
            <select id="newbuilding-complex-select" class="form-control" style="width: 100%"></select>
