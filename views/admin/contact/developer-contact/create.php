...
$this->title = "Добавить контакт для застройщика {$developer->name}";
...
$this->params['breadcrumbs'][] = ['label' => 'Контакты', 'url' => ['admin/contact/developer-contact/index', 'developerId' => $developer->id]];
