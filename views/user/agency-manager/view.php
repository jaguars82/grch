...
$this->params['breadcrumbs'][] = ['label' => 'Администраторы', 'url' => ['agency/view', 'id' => $model->agency->id]];
...
<div class="contact-view">
    ...
    <p style="margin-bottom: 20px">
        <?= Html::a('Обновить', ['user/agency-manager/update', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Удалить', ['user/agency-manager/delete', 'id' => $model->id], [
            'class' => 'btn btn-danger',
            'data' => [
                'confirm' => 'Вы уверены, что хотите удалить администратора агенства?',
                'method' => 'post',
            ],
        ]) ?>
    </p>
