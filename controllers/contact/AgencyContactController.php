...
class AgencyContactController extends Controller
{
    ...
    public function actionCreate($agencyId)
    {
        ...
        if (\Yii::$app->request->isPost && $form->load(\Yii::$app->request->post()) && $form->process()) {         
            ...
            return $this->redirectWithSuccess(['agency/view', 'id' => $agency->id], 'Добавлен контакт');
        }
    ...
    public function actionUpdate($id)
    {
        ...
        if (\Yii::$app->request->isPost && $form->load(\Yii::$app->request->post()) && $form->process()) {            
            ...
            return $this->redirectWithSuccess(['admin/contact/agency-contact/updatee', 'id' => $model->id], 'Контакт обновлен');
        }
    ...
    public function actionDelete($id)
    {
        ...
        return $this->redirectWithSuccess(['agency/view', 'id' => $agencyId], 'Контакт удален');
    }
