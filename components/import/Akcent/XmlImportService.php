...
namespace app\components\import\Akcent;
...
/**
 * Service for importing flat's data from xml-feed for developer "Акцент"
 */
			...
			foreach ($complex->buildings->building as $building) {
				...
				foreach ($building->flats->flat as $flat) {
		            ...
		            $_flat = [
		                ...
		                'status' => $flat->layout_type == 'free' ? Flat::STATUS_SALE : Flat::STATUS_SOLD,
						'layout' => $layout,
		            ];
